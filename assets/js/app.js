    ...
    function navbar_change() {
        $(window).scroll(function () {
            if ($(window).scrollTop() > 350) {
                $('.navbar-inner').css('background', '#fff');
                $('.navbar-inner').css('-ms-filter', 'alpha(opacity=1)');
            } else if ($(window).scrollTop() < 350) {
                $('.navbar-inner').css('background', 'none');
                $('.navbar-inner').css('-ms-filter', 'progid:DXImageTransform.Microsoft.Alpha(Opacity=0)');
            }
        });
    ...
    function medium_navbar_change() {
        $(window).scroll(function () {
            if ($(window).scrollTop() > 500) {
                ...
                $('.navbar-inner').css('-ms-filter', 'progid:DXImageTransform.Microsoft.Alpha(Opacity=)');
